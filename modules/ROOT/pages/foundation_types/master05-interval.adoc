...
include::../UML/classes/{pkg}interval.adoc[]

include::../UML/classes/{pkg}point_interval.adoc[]

include::../UML/classes/{pkg}proper_interval.adoc[]

include::../UML/classes/{pkg}multiplicity_interval.adoc[]

include::../UML/classes/{pkg}cardinality.adoc[]
