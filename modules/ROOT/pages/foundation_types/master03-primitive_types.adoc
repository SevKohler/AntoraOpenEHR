...
include::../UML/classes/{pkg}boolean.adoc[]

include::../UML/classes/{pkg}ordered.adoc[]

include::../UML/classes/{pkg}character.adoc[]

include::../UML/classes/{pkg}octet.adoc[]

include::../UML/classes/{pkg}string.adoc[]

include::../UML/classes/{pkg}uri.adoc[]

include::../UML/classes/{pkg}numeric.adoc[]

include::../UML/classes/{pkg}ordered_numeric.adoc[]

include::../UML/classes/{pkg}integer.adoc[]

include::../UML/classes/{pkg}integer64.adoc[]

include::../UML/classes/{pkg}real.adoc[]

include::../UML/classes/{pkg}double.adoc[]
